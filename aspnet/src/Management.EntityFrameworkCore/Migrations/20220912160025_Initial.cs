        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cash_receipt_type = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    C_code = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    C_name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    C_phone = table.Column<string>(type: "nvarchar(11)", maxLength: 11, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    U_code = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OR_code = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ID_cus = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ID_user = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppOrderRepairs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PR_quote_date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PR_status_error = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PR_price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Product_repair_type = table.Column<int>(type: "int", nullable: false),
                    ID_order_repair = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ID_detail = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
